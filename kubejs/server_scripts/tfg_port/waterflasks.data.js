...
TFCEvents.data(event => {
	...
	event.heat({ ingredient: 'waterflasks:unfinished_iron_flask', heat_capacity: 0.2345 }, 'tfg:waterflasks/unfinished_iron_flask') // [PORT-FIX] itemHeat -> heat
	event.heat({ ingredient: 'waterflasks:broken_iron_flask', heat_capacity: 0.2345 }, 'tfg:waterflasks/broken_iron_flask') // [PORT-FIX] itemHeat -> heat
	event.heat({ ingredient: 'waterflasks:iron_flask', heat_capacity: 0.2345 }, 'tfg:waterflasks/iron_flask') // [PORT-FIX] itemHeat -> heat
})
