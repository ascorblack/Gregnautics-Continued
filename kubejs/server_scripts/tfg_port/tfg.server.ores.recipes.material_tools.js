...
// [PORT] Из TFG server_scripts/tfg/ores_and_materials/recipes.material_tools.js
//   (processToolMortar/processGTToolHead/processToolHead/modifyRecyclingAmounts).
// [PORT-Ф2] ФАЙЛ ПОЛНОСТЬЮ ЗАБЛОКИРОВАН Фазой 2/Ф3:
//   - вызывается из главного цикла recipes.materials.js (Ф2-заблокирован);
//   - TFGTagPrefix.toolHead* (sword/pickaxe/... TFC-инструменты) не зарегистрированы;
//   - крафт GT-инструментов через TFC.itemStackProvider.copyForgingBonus().copyHeat() и
//     extruder-молды tfg:*_extruder_mold (Ф4-предметы не зарегистрированы);
//   - vintageimprovements.curving -> createvintageneoforged (сверить схему при порте);
//   - modifyRecyclingAmounts трогает TFGTagPrefix — недоступно.
// [PORT] При порте учесть: forge:rods/* -> c:rods/*, forge:tools/screwdrivers -> c:tools/screwdriver,
//   forge:small_springs -> c:small_springs, advanced_shaped_crafting без хвостовых 0,0,
//   advanced_shapeless_crafting уже с 3-м аргументом (primaryIngredient) — ок.

console.info('[Gregnautics] progress: tfg_port tfg.server.ores.recipes.material_tools [PORT-Ф2] пропущен (см. шапку)')
