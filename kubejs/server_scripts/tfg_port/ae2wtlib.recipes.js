...
ServerEvents.recipes(event => {
	console.info('[Gregnautics] progress: tfg_port ae2wtlib recipes start')
	...
	event.recipes.gtceu.assembler('ae2wtlib:wireless_pattern_encoding_terminal')
		.itemInputs(
			...
			'2x gtceu:ev_sensor',
			'gtceu:ev_emitter',
			'2x #c:rods/ultimet') // [PORT] forge: -> c:
	...
	event.recipes.gtceu.assembler('ae2wtlib:magnet_card')
		.itemInputs(
			'#c:ingots/magnetic_neodymium', // [PORT] forge: -> c:
			'4x #c:rods/magnetic_neodymium', // [PORT] forge: -> c:
			'ae2:advanced_card',
	...
	event.recipes.gtceu.assembler('ae2wtlib:wireless_universal_terminal')
		.itemInputs(
			...
			'1x gtceu:ev_sensor',
			'1x gtceu:ev_emitter',
			'2x #c:plates/rhodium') // [PORT] forge: -> c:
