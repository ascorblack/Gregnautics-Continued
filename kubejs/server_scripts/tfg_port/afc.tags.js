...
// [PORT] Портировано из afc/tags.js (TerraFirmaGreg-Modern 1.20.1 -> 1.21.1)
// [PORT] registerAFCItemTags / registerAFCBlockTags / registerAFCFluidTags -> прямые обработчики ServerEvents.tags (KubeJS 7: изолированные скоупы)

ServerEvents.tags('item', event => {
	console.info('[Gregnautics] progress: tfg_port afc item tags start')
...
ServerEvents.tags('block', event => {
	console.info('[Gregnautics] progress: tfg_port afc block tags start')
...
ServerEvents.tags('fluid', event => {
	console.info('[Gregnautics] progress: tfg_port afc fluid tags start')
