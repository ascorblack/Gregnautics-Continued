...
// [PORT] KubeJS 7: изолированный scope, регистрируем событие напрямую вместо registerBlockRunnerBlockTags(event)
ServerEvents.tags('block', event => {
	console.info('[Gregnautics] progress: tfg_port blockrunner block tags start')
