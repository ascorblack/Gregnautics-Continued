...
// [PORT] Из TFG server_scripts/tfg/ores_and_materials/recipes.chromium.js (registerTFGChromiumProcessing).
// [PORT-Ф2] ФАЙЛ ПОЛНОСТЬЮ ЗАБЛОКИРОВАН Фазой 2: tfg:dirty/filtered/clean_ruby_slurry (жидкости),
//   tfg:chromium_3_oxide/sodium_aluminium/mixed_garnet/sodium_chromate/sodium_dichromate/
//   sodium_sulfate/wollastonite/ferrochrome/alumina/aluminium_hydroxide_dust — кастомные материалы TFG.
// ВАЖНО: удаления стоковых GT-рецептов (electrolyzer ruby/uvarovite/chromite, centrifuge slurry,
//   garnet_sand) СОЗНАТЕЛЬНО НЕ ПРИМЕНЕНЫ — пока Ф2-замены нет, они оставили бы паку
//   без пути к хрому. Применить вместе с разблокировкой Ф2.

console.info('[Gregnautics] progress: tfg_port tfg.server.ores.recipes.chromium [PORT-Ф2] пропущен (см. шапку)')
