...
// [PORT] Из TFG server_scripts/tfg/ores_and_materials/recipes.materials.js (registerTFGMaterialRecipes —
//   ГЛАВНЫЙ ЦИКЛ обработки материалов + общие хелперы addTFCMelting/addAnvilRecipe/addMaterialCasting/
//   addMaterialWelding/addMaterialRecycling).
// [PORT-Ф2] ФАЙЛ ЗАБЛОКИРОВАН Фазой 2/Ф3:
//   - TFGPropertyKey.TFC_PROPERTY (температуры плавки, тиры наковальни) — Java-мод TFG-Core,
//     в 1.21.1 отсутствует; без него addTFCMelting/addAnvilRecipe/addMaterialCasting неработоспособны;
//   - TFGMaterialFlags навешиваются Ф2-модификациями материалов (диспетчер отключён) — ни один
//     материал сейчас их не имеет;
//   - TFGTagPrefix.* (toolHead*, ingotDouble, powder, anvil, lamp...) не зарегистрированы;
//   - greate (GreateMaterials, greate.compacting) отсутствует; TFGHelpers.registerMaterialInfo — Ф4.
// [PORT] KubeJS 7: файлы изолированы — рудная часть цикла уже живёт в
//   tfg.server.ores.recipes.material_ores.js (аддитивные quern/barrel/ae2-рецепты);
//   интерим-замены плавки/кверны дают gregnautics_gtceu_ore_melting_compat.js и
//   gregnautics_gtceu_ore_powder_compat.js. При разблокировке Ф2 портировать цикл целиком.

console.info('[Gregnautics] progress: tfg_port tfg.server.ores.recipes.materials [PORT-Ф2] пропущен (см. шапку)')
