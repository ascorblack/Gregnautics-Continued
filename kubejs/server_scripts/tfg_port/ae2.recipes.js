...
// [PORT] функция registerAE2Recipes заменена на прямую регистрацию ServerEvents.recipes
// [PORT] Теги forge:* -> c:* (NeoForge), forge:sheets/X -> c:plates/X (GTM8)
ServerEvents.recipes(event => {
	console.info('[Gregnautics] progress: tfg_port ae2 recipes start')


	// Удаление рецептов мода
	// [PORT-Ф2-TEMP] Полное удаление ae2-рецептов ВРЕМЕННО ОТКЛЮЧЕНО: замены на основе
	// tfg:fluix / tfg:cryogenized_fluix закомментированы (Ф2 заблокирована апстримом),
	// и с remove-all процессоры/ячейки/интерфейсы AE2 стали бы некрафтовыми.
	// После фикса Ф2 вернуть remove и раскомментировать [PORT-Ф2]-рецепты ниже.
	// event.remove({
	// 	not: [
	...
	event.recipes.gtceu.shaped('ae2:certus_quartz_cutting_knife', [
		...
		A: '#c:rods/wooden',
		B: '#c:plates/steel',
		C: '#c:exquisite_gems/certus_quartz',
	...
	event.recipes.gtceu.shaped('ae2:nether_quartz_cutting_knife', [
		...
		A: '#c:rods/wooden',
		B: '#c:plates/steel',
		C: '#c:exquisite_gems/nether_quartz',
	...
	event.recipes.gtceu.shaped('ae2:network_tool', [
		...
		A: '#c:tools/wrench', // [PORT-FIX] тег в 1.21 единственного числа
		B: '#gtceu:circuits/lv',
	...
	event.recipes.gtceu.shaped('ae2:semi_dark_monitor', [
		...
		A: '#c:plates/glowstone',
		B: '#c:plates/aluminium',
		C: '#c:plates/red_alloy',
		D: 'ae2:quartz_glass'
	...
	//Auto Crafting Card
	// [PORT] ae2:auto_complete_card отсутствует в 1.21 (AE2 19.2.17 не содержит этот предмет)
	...
	event.recipes.gtceu.shaped('ae2:terminal', [
		...
		A: '#c:tools/screwdriver', // [PORT-FIX] тег в 1.21 единственного числа
		B: '#ae2:illuminated_panel',
		C: '#c:tools/mallet', // [PORT-FIX] тег в 1.21 единственного числа
		D: '#c:rods/steel',
		E: '#gtceu:circuits/hv',
		F: '#c:plates/steel',
		G: '#c:screws/steel'
	...
	// Glass Cable
	// [PORT-Ф2] #c:small_dusts/fluix — материал fluix ещё не зарегистрирован
	// event.recipes.gtceu.assembler('fluix_glass_cable')
		// .itemInputs(
			// '2x #c:rods/quartzite',
			// '3x ae2:quartz_fiber',
			// '#c:fine_wires/borosilicate_glass',
			// '#c:small_dusts/fluix')
	...
	// [PORT] ae2:pattern_box отсутствует в 1.21 (AE2 19.2.17 не содержит этот предмет)
	...
	// [PORT-Ф2] жидкость tfg:fluix / tfg:cryogenized_fluix — материал tfg ещё не зарегистрирован (Фаза 2)
	// event.recipes.gtceu.assembler('ae2:annihilation_core')
		// .itemInputs(
			// '2x #c:rods/certus_quartz',
	...
	// [PORT-Ф2] жидкость tfg:fluix / tfg:cryogenized_fluix — материал tfg ещё не зарегистрирован (Фаза 2)
	// [PORT] ad_astra отсутствует в сборке 1.21.1
	...
	// event.recipes.gtceu.assembler('ae2:cell_component_16k_4k')
		// .itemInputs(
			...
			// '16x gtceu:ram_chip',
			// '16x #c:foils/polyvinyl_chloride',
	...
	// event.recipes.gtceu.assembler('ae2:cell_component_64k_16k')
		// .itemInputs(
			...
			// '64x #c:foils/polyvinyl_chloride',
	...
	// event.recipes.gtceu.assembler('ae2:cell_component_256k_64k')
		// .itemInputs(
			...
			// '64x #c:foils/polyphenylene_sulfide',
			// '64x #c:foils/polyphenylene_sulfide',
			// '64x ae2:logic_processor',
			// '64x ae2:logic_processor',
	...
	// event.recipes.gtceu.assembler('ae2:spatial_cell_component_2')
		// .itemInputs(
			...
			// '4x #c:plates/titanium',
			// '32x #c:dusts/certus_quartz',
	...
	// event.recipes.gtceu.assembler('ae2:spatial_cell_component_128')
		// .itemInputs(
			...
			// '4x #c:plates/rhodium_plated_palladium',
			// '32x #c:dusts/certus_quartz',
			// 'ae2:calculation_processor')
		// .inputFluids(Fluid.of('tfg:fluix', 144))
	...
	event.recipes.gtceu.forming_press('ae2:printed_calculation_processor')
		...
		.notConsumableItem( // [PORT-FIX] notConsumable(string) не существует в GTM8
	...
	event.recipes.gtceu.forming_press('ae2:silicon_press_stainless_steel')
		.itemInputs('#c:plates/stainless_steel')
		.notConsumableItem( // [PORT-FIX] notConsumable(string) не существует в GTM8
			'ae2:silicon_press')
	...
	event.recipes.gtceu.alloy_smelter('ae2:quartz_glass')
		.itemInputs('#c:glass', '#c:dusts/certus_quartz')
	...
	event.recipes.gtceu.alloy_smelter('ae2:quartz_vibrant_glass')
		.itemInputs('ae2:quartz_glass', '#c:dusts/glowstone')
	...
	event.recipes.gtceu.packer('ae2:view_cell')
		.itemInputs('ae2:item_cell_housing', '#c:gems/certus_quartz')
	...
	event.recipes.gtceu.packer('ae2:view_cell_back')
		...
		.itemOutputs('ae2:item_cell_housing', '#c:gems/certus_quartz')
		.duration(10)
		.EUt(12)
	...
	// [PORT-Ф2] жидкость tfg:fluix / tfg:cryogenized_fluix — материал tfg ещё не зарегистрирован (Фаза 2)
	// [PORT-Ф4] tfg:cryo_fluix_pearl не существует
	// [PORT] ad_astra отсутствует в сборке 1.21.1
	...
	// Chemical Reactor
	// [PORT-Ф2] жидкость tfg:fluix / tfg:cryogenized_fluix — материал tfg ещё не зарегистрирован (Фаза 2)
	// [PORT-Ф4] tfg:vitrified_pearl не существует
	// event.recipes.gtceu.chemical_reactor('ae2:fluix_pearl')
		// .itemInputs('4x #c:gems/fluix', 'tfg:vitrified_pearl')
		// .inputFluids(Fluid.of('tfg:fluix', 576))
