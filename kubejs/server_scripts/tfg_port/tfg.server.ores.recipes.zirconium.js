...
// [PORT] Из TFG server_scripts/tfg/ores_and_materials/recipes.zirconium.js (registerTFGZirconiumRecipes).
// [PORT-Ф2] ФАЙЛ ПОЛНОСТЬЮ ЗАБЛОКИРОВАН Фазой 2: tfg:silicon_tetrachloride (жидкость),
//   дасты zircon / zirconium_tetrachloride / zirconium(_bromide/_diboride) / boron_carbide и
//   hot_ingots/zirconium — кастомные GT-материалы TFG (tfg.materials.zirconium.js, Ф2).

console.info('[Gregnautics] progress: tfg_port tfg.server.ores.recipes.zirconium [PORT-Ф2] пропущен (см. шапку)')
