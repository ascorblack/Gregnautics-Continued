...
// [PORT] Из TFG server_scripts/tfg/ores_and_materials/recipes.bromine.js (registerTFGBromineRecipes).
// [PORT] Тело было полностью закомментировано уже в оригинале (WIP-линия брома).
// [PORT-Ф2] Все жидкости линии (raw_brine, hot_brine, debrominated_brine и т.д.) — кастомные
//   GT-материалы TFG (Фаза 2), типы рецептов evaporation_tower/heat_exchanger — кастомные (Ф2/Ф7).

console.info('[Gregnautics] progress: tfg_port tfg.server.ores.recipes.bromine [PORT-Ф2] пропущен (см. шапку)')
