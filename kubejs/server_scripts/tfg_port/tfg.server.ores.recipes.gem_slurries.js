...
// [PORT] Из TFG server_scripts/tfg/ores_and_materials/recipes.gem_slurries.js (registerTFGGemSlurriesProcessing).
// [PORT-Ф2] ФАЙЛ ПОЛНОСТЬЮ ЗАБЛОКИРОВАН Фазой 2:
//   - все tfg:dirty/filtered/clean_*_slurry — кастомные жидкости TFG (tfg.materials.gem_slurries.js, Ф2);
//   - тип рецепта coal_liquefaction_tower — кастомный мультиблок TFG (Ф7);
//   - материалы armalcolite, perlite — кастомные GT-материалы TFG;
//   - TFGHelpers.getMaterial — Java-мод TFG-Core.

console.info('[Gregnautics] progress: tfg_port tfg.server.ores.recipes.gem_slurries [PORT-Ф2] пропущен (см. шапку)')
