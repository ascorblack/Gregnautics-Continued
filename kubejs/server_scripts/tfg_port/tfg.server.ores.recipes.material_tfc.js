...
// [PORT] Из TFG server_scripts/tfg/ores_and_materials/recipes.material_tfc.js
//   (processTFCArmor/processTFCTool/processPlatedBlock/processTongs).
// [PORT-Ф2] ФАЙЛ ПОЛНОСТЬЮ ЗАБЛОКИРОВАН Фазой 2/Ф3:
//   - вызывается только для материалов с TFGMaterialFlags.HAS_TFC_ARMOR/HAS_TFC_TOOL/HAS_TFC_UTILITY —
//     флаги навешивают Ф2-модификации материалов (диспетчер отключён), сейчас их нет ни у кого;
//   - addAnvilRecipe/addTFCMelting требуют TFGPropertyKey.TFC_PROPERTY (Java-мод TFG-Core);
//   - TFGTagPrefix.toolHead* / blockPlated / slabPlated / stairPlated не зарегистрированы;
//   - tfcscraping отсутствует в сборке; tfchotornot ПРИСУТСТВУЕТ (processTongs вернуть при Ф2).
// [PORT] При порте учесть: forge:tools/hammers -> c:tools/hammer, forge:bolts -> c:bolts,
//   damage_inputs_* удалены в kubejs_tfc 2.0 (обычный shapeless), advanced_shaped_crafting без 0,0.

console.info('[Gregnautics] progress: tfg_port tfg.server.ores.recipes.material_tfc [PORT-Ф2] пропущен (см. шапку)')
