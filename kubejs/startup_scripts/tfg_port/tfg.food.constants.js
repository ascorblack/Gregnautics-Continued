...
// [PORT] Из TFG startup_scripts/tfg/food/constants.food.js (Ф4, еда).
// Только данные (global.*) — регистрации в tfg.food.items.js / tfg.food.fluids.js.
// [PORT] betterend, wan_ancient_beasts, species, ad_astra отсутствуют в 1.21.1 —
// их записи закомментированы ([PORT] / [PORT-Ф10]).
...
global.TFG_CREATE_GENERIC_FOOD_ITEM = /** @type {TFGCreateGenericFoodItem[]} */ ([
	...
	// [PORT-Ф10] betterend отсутствует (марсианские культуры Ad Astra) — блок закомментирован:
	// Amber Root, Blossom Berry, Cave Pumpkin (+ pie), Chorus Mushroom, Shadow Berry, Bolux Mushroom.
	/*
	// Amber Root
	{
...
global.FOOD_FRUIT = [
	...
	// [PORT-Ф10] betterend отсутствует — cave_pumpkin, blossom_berry, shadow_berry закомментированы:
	/*
...
global.CROP_CLIMATE_DATA = [
	...
	// ============== Mars =================
	// [PORT-Ф10] betterend и ad_astra отсутствуют — марсианские культуры закомментированы:
	/*
	{
...
global.TFG_FOOD_COOKING = /** @type {FoodCooking[]} */ ([
	...
	// [PORT-Ф10] betterend отсутствует:
	...
	// [PORT] wan_ancient_beasts отсутствует:
