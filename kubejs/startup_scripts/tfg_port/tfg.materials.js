...
const registerTFGMaterials = (event) => {
	...
	event.create('gtceu:unknown')
		.color('0xFFFFFF')
		.formula('?')
		.flags(GTMaterialFlags.DISABLE_DECOMPOSITION)
		
	event.create('gtceu:ammonium')
		.components('1x nitrogen', '4x hydrogen')
		.flags(GTMaterialFlags.DISABLE_DECOMPOSITION)

	event.create('gtceu:methoxy')
		.components('1x oxygen', '1x carbon', '3x hydrogen')
		.flags(GTMaterialFlags.DISABLE_DECOMPOSITION)

	event.create('gtceu:methylene')
		.components('1x carbon', '2x hydrogen')
		.flags(GTMaterialFlags.DISABLE_DECOMPOSITION)

	event.create('gtceu:hydroxide')
		.components('1x oxygen', '1x hydrogen')
		.flags(GTMaterialFlags.DISABLE_DECOMPOSITION)

	event.create('gtceu:sulfate')
